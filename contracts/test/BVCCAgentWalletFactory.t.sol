...
import {BVCCAgentWalletFactoryV1} from "../src/BVCCAgentWalletFactory.sol";

contract BVCCAgentWalletFactoryV1Test is Test {
    BVCCAgentWalletFactoryV1 factory;
    ...
    function setUp() public {
        factory = new BVCCAgentWalletFactoryV1(OWNER);
    }
    ...
    function test_KillOnlyOwner() public {
        ...
        vm.expectRevert(BVCCAgentWalletFactoryV1.NotOwner.selector);
        factory.kill();
    }
    ...
    function test_KillBlocksCreation() public {
        ...
        vm.expectRevert(BVCCAgentWalletFactoryV1.FactoryKilledError.selector);
    ...
    function test_KillEmitsEvent() public {
        ...
        emit BVCCAgentWalletFactoryV1.FactoryKilled(OWNER);
        vm.prank(OWNER);
        factory.kill();
    }
}
