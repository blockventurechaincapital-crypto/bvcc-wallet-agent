export const recovery = {
  en: {
    recovery: {
      ...
      cancelWarningDesc: "A guardian has initiated the recovery of your wallet. If you did not authorise this process, cancel it now with your Face ID.",
      cancelBtn: 'Cancel recovery with Face ID',
      cancelBtnSigning: 'Waiting for Face ID…',
  ...
  es: {
    recovery: {
      ...
      cancelWarningDesc: 'Un guardian ha iniciado la recuperación de tu wallet. Si no autorizaste este proceso, cancélalo ahora con tu Face ID.',
      cancelBtn: 'Cancelar recovery con Face ID',
      cancelBtnSigning: 'Esperando Face ID...',
