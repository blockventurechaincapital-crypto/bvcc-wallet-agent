export const marketing = {
  ...
  es: {
    marketing: {
      ...
      faqA2: 'Defines los límites y el contrato los aplica on-chain: topes de gasto (por transacción, diario, por periodo y total, en el token nativo y por cada ERC-20), una lista de tokens permitidos, los protocolos a los que puede llamar, una whitelist de destinatarios opcional, una fecha de caducidad y una pausa instantánea. El agente tiene su propio par de claves y nunca puede superarlos; BVCC nunca ve las claves del agente.',
      faqQ3: '¿Qué agentes de IA y clientes MCP se pueden conectar?',
      faqA3: 'Cualquier cliente MCP (Model Context Protocol) se conecta en un comando, incluidos Hermes, Claude, Cursor y LM Studio. El servidor registra 53 tools que el agente invoca para transaccionar dentro de sus límites: transferencias, swaps en Uniswap v3 y v4, préstamos en Aave v3 y posiciones de liquidez en Uniswap. El modo solo-lectura y los filtros por módulo permiten exponer menos.',
