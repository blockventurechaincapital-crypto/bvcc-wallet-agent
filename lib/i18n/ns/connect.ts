export const connect = {
  en: {
    connect: {
      ...
      waitingTitle: 'Sending',
      waitingNote: 'Submitted to the network. The dApp already has the transaction hash — you can follow it on the explorer.',
      stillPendingTitle: 'Still pending',
      stillPendingNote: 'It has not confirmed yet. It may still go through: follow it on the explorer.',
  ...
  es: {
    connect: {
      ...
      waitingTitle: 'Enviando',
      waitingNote: 'Enviada a la red. La dApp ya tiene el hash — puedes seguirla en el explorador.',
      stillPendingTitle: 'Sigue pendiente',
      stillPendingNote: 'Todavía no ha confirmado. Puede entrar aún: síguela en el explorador.',
